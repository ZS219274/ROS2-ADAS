...
{
  RCLCPP_INFO(rclcpp::get_logger("global_planner_normal.cpp"),
              "GlobalPlannerNormal init!");
...
Path GlobalPlannerNormal::search_global_path(
    const PNCMap& pnc_map)  // 全局路径搜索
{
  RCLCPP_INFO(rclcpp::get_logger("global_planner_normal.cpp"),
              "GlobalPlannerNormal search_global_path!");
  ...
  RCLCPP_INFO(rclcpp::get_logger("global_planner_normal.cpp"),
              "global_path created points size: %ld!",
