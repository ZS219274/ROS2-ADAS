...
PncMapCreatorSturn::PncMapCreatorSturn() {
  RCLCPP_INFO(rclcpp::get_logger("pnc_map_creator_sturn.cpp"),
              "PncMapCreatorSturn created.");
...
void PncMapCreatorSturn::draw_straight_x(const double& length,
...
void PncMapCreatorSturn::draw_straight_y(const double& length,
                                         const double& plus_flag,
...
void PncMapCreatorSturn::draw_arc(
