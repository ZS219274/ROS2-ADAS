...
// 需要包含 OSQP 内部头文件以获取 csc_set_data 函数
#ifdef OSQP_EIGEN_OSQP_IS_V1
#include <csc_utils.h>  // 需要 csc_set_data 函数
#endif
...
extern void OSQPCscMatrix_set_data(OSQPCscMatrix* M, OSQPInt m, OSQPInt n, OSQPInt nnz, OSQPFloat* x, OSQPInt* i, OSQPInt* p);
}
...
// 使用 OSQPCscMatrix_set_data，它在库中可用
